...
export default async function GraphPage() {
  ...
  return (
    <section className="p-6 lg:p-8 max-w-[1400px] mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Knowledge Graph</h1>
        <p className="text-sm text-slate-500 mt-1">
          Interactive visualization of entities, claims, relations, citations, and document references.
        </p>
      </div>
